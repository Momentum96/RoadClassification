...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.firstLayout_1.setObjectName("firstLayout_1")
        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.SteerLeftLayout = QVBoxLayout()
        self.SteerLeftLayout.setSpacing(0)
        self.SteerLeftLayout.setObjectName("SteerLeftLayout")
        ...
        self.slsetButton.setObjectName("slsetButton")
        ...
        self.SteerRightLayout.setObjectName("SteerRightLayout")
        ...
        self.srsetButton.setObjectName("srsetButton")
        ...
        self.veichleLabel.setObjectName("veichleLabel")
        self.veichleLabel.setMinimumSize(QSize(0, 500))
        self.veichleLabel.setMaximumSize(QSize(200, 16777215))
        self.veichleLabel.setPixmap(QPixmap(":/image/vehicle_2-removebg-preview.png"))
        ...
        self.RearLeftLayout.setObjectName("RearLeftLayout")
        ...
        self.rlEdit.setObjectName("rlEdit")
        ...
        self.rlsetButton.setObjectName("rlsetButton")
        ...
        self.RearRightLayout.setObjectName("RearRightLayout")
        ...
        self.rrEdit.setObjectName("rrEdit")
        ...
        self.rrsetButton.setObjectName("rrsetButton")
        ...
        self.firstLayout_3.setObjectName("firstLayout_3")
        self.spectrogramLayout_1 = QHBoxLayout()
        self.spectrogramLayout_1.setObjectName("spectrogramLayout_1")
        self.spectrogramLabel_1 = QLabel(Form)
        self.spectrogramLabel_1.setObjectName("spectrogramLabel_1")
        sizePolicy3 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(
            self.spectrogramLabel_1.sizePolicy().hasHeightForWidth()
        )
        ...
        self.spectrogramLabel_1.setPixmap(QPixmap(":/image/merged_img_0.png"))
        ...
        self.spectrogramLayout_2.setObjectName("spectrogramLayout_2")
        self.spectrogramLabel_2 = QLabel(Form)
        self.spectrogramLabel_2.setObjectName("spectrogramLabel_2")
        sizePolicy2.setHeightForWidth(
            self.spectrogramLabel_2.sizePolicy().hasHeightForWidth()
        )
        ...
        self.spectrogramLabel_2.setPixmap(QPixmap(":/image/merged_img_1.png"))
        ...
        self.spectrogramLayout_3.setObjectName("spectrogramLayout_3")
        self.spectrogramLabel_3 = QLabel(Form)
        self.spectrogramLabel_3.setObjectName("spectrogramLabel_3")
        self.spectrogramLabel_3.setMinimumSize(QSize(150, 150))
        self.spectrogramLabel_3.setMaximumSize(QSize(200, 200))
        self.spectrogramLabel_3.setPixmap(QPixmap(":/image/merged_img_2.png"))
        ...
        self.spectrogramLayout_4.setObjectName("spectrogramLayout_4")
        self.spectrogramLabel_4 = QLabel(Form)
        self.spectrogramLabel_4.setObjectName("spectrogramLabel_4")
        sizePolicy2.setHeightForWidth(
            self.spectrogramLabel_4.sizePolicy().hasHeightForWidth()
        )
        ...
        self.spectrogramLabel_4.setPixmap(QPixmap(":/image/merged_img_3.png"))
        self.spectrogramLabel_4.setScaledContents(True)
        self.spectrogramLabel_4.setAlignment(
        ...
        self.firstLayout_4.setObjectName("firstLayout_4")
        ...
        self.concatedspectrogramLabel.setObjectName("concatedspectrogramLabel")
        self.concatedspectrogramLabel.setMinimumSize(QSize(300, 300))
        self.concatedspectrogramLabel.setPixmap(QPixmap(":/image/concated_img_0.png"))
        ...
        font = QFont()
        font.setFamilies(["\ub098\ub214\uace0\ub515 ExtraBold"])
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", "STEER LEFT", None))
        self.slEdit.setText("")
        self.slsetButton.setText(QCoreApplication.translate("Form", "Set", None))
        self.label_3.setText(QCoreApplication.translate("Form", "STEER RIGHT", None))
        self.srsetButton.setText(QCoreApplication.translate("Form", "Set", None))
        self.veichleLabel.setText("")
        self.label_4.setText(QCoreApplication.translate("Form", "REAR LEFT", None))
        self.rlsetButton.setText(QCoreApplication.translate("Form", "Set", None))
        self.label_5.setText(QCoreApplication.translate("Form", "REAR RIGHT", None))
        self.rrsetButton.setText(QCoreApplication.translate("Form", "Set", None))
        self.startButton.setText(QCoreApplication.translate("Form", "Start", None))
